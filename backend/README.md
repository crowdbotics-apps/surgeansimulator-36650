...
## Project Structure
    ...
    ├── surgeansimulator_36650  # Django project configurations
...
1. Clone this repo and `cd surgeansimulator_36650`
...
2. Clone this repo and `cd surgeansimulator_36650`
